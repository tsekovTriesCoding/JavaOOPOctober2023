...
public class ControllerImpl implements Controller {
    ...
    public String equipmentRequirement(String gameplayName, String equipmentType) {
        ...
        this.gameplays
                .stream()
                .filter(g -> gameplayName.equals(g.getName()))
                .findFirst()
    ...
    public String addTeam(String gameplayName, String teamType, String teamName, String country, int advantage) {
        ...
        String output = "";
        if (gameplay != null) {
            switch (gameplay.getClass().getSimpleName()) {
                case "Outdoor":
                    if (team.getClass().getSimpleName().equals("Bulgaria")) {
                        gameplay.addTeam(team);
                        output = String.format(ConstantMessages.SUCCESSFULLY_ADDED_TEAM_IN_GAMEPLAY, teamType, gameplayName);
                    }
                    break;
                case "Indoor":
        ...
        if (output.isEmpty()) {
            output = ConstantMessages.GAMEPLAY_NOT_SUITABLE;
        }
    ...
    public String playInGameplay(String gameplayName) {
        Gameplay gameplay = this.gameplays.stream().filter(g -> gameplayName.equals(g.getName())).findFirst()
                .orElse(null);
    ...
    public String percentAdvantage(String gameplayName) {
        Gameplay gameplay = this.gameplays
                .stream().filter(g -> gameplayName.equals(g.getName()))
                .findFirst()
                .orElse(null);
